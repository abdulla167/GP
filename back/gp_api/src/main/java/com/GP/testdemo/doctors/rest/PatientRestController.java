...
public class PatientRestController {
	...
	public Appointment addAppointment(@RequestBody Appointment theAppointment,HttpSession session) {
		...
		doctor.addDoctorAppointment(theAppointment);
		theDoctorService.clear();
		//System.out.println(patient.toString());
		patient.addPatientAppointment(theAppointment);
...
//		thePatientService.saveS(thePatient.getSign());
		thePatient.getSign().setEnabled(0);
...
//		thePatientService.updateS(thePatient.getSign());
	...
	public String signPatient(@RequestBody  SignIn patientSign, HttpServletRequest session) {
...
//			System.out.println(doctor.toString());
			dbPatient.getSign().setEnabled(1);
			thePatientService.updateD(dbPatient);
			return " Succesful Sign in";
		}else {
			dbPatient.getSign().setEnabled(0);
			thePatientService.updateD(dbPatient);
			return "Failure";
		}
	}
