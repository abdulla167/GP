...
import 'package:my_baby/screens/video_player/video_screen.dart';
  ...
  Widget _buildButton() {
    return Center(
      child: ElevatedButton(
        ...
        onPressed: () => NavigatorKeys.rootNavigationKey.currentState.push(
            MaterialPageRoute(builder: (_) => VideoScreen(widget.videoId))),
        style: ButtonStyle(
